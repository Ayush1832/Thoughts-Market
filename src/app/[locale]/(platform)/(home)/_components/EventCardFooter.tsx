    ...
    <div className="flex items-center justify-between gap-2 text-xs text-muted-foreground">
      <div className="flex items-center gap-2">
        {showLiveBadge && !shouldShowNewBadge && (
          <span className="
            flex items-center gap-1.5 rounded-full border border-[#00d4ff]/25 bg-[#00d4ff]/8 px-2 py-0.5
            shadow-[0_0_8px_rgba(0,212,255,0.15)]
          "
          >
            ...
            <span className="text-2xs leading-none font-bold tracking-wider text-[#00d4ff] uppercase">Live</span>
          </span>
        )}
        {shouldShowNewBadge
          ? <NewBadge />
