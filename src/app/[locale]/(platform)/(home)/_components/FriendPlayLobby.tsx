...
function AvatarCircle({ letter, className }: { letter: string, className?: string }) {
  return (
    <div className={cn(
...
export default function FriendPlayLobby({ onClose }: { onClose?: () => void }) {
  ...
  return (
    <div className="
      animate-fade-in overflow-hidden rounded-3xl border border-border/40 bg-card
      ...
      <div className="flex items-center justify-between border-b border-border/40 px-5 py-4">
        ...
        <div className="flex items-center gap-2">
          <span className="rounded-full bg-primary/15 px-2 py-0.5 text-xs font-semibold text-primary">
            {allRooms.filter(r => r.status === 'open' || r.status === 'playing').length}
            {' '}
            active
          </span>
          ...
          {showCreate
            ...
            : (
                <button
                  ...
                  className="
                    w-full rounded-2xl border-2 border-dashed border-border/50 px-4 py-2.5 text-sm font-medium
                    ...
                    <div className="flex items-center gap-2.5">
                      <div className={cn(
                        ...
                        room.status === 'playing'
                          ...
                          : `bg-linear-to-br from-[#7d6cff] to-[#54e3ff]`,
                      )}
                      >
                      ...
                      <div className="min-w-0 flex-1">
                        <div className="flex items-center gap-1.5">
                          ...
                          {room.status === 'playing' && (
                            <span className="flex items-center gap-1 text-2xs font-bold text-green-400">
                  ...
                  <div className="flex flex-col gap-3">
                    ...
                    {activeTab === 'Discussion' && (
                      <>
                        ...
                        <div className="
                          flex items-center gap-2 rounded-xl border border-border/40 bg-muted/40 px-3 py-2
                        "
                        >
                    ...
                    {currentParticipants.length > 0 && (
                      <div className="rounded-xl border border-border/40 bg-muted/30 p-3">
                        <p className="mb-2 text-2xs font-semibold tracking-wider text-muted-foreground/60 uppercase">
                          Players (
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {currentParticipants.map(p => (
                            <div
                              key={p.id}
                              className="
                                flex items-center gap-1.5 rounded-full border border-border/40 bg-card px-2 py-1
                              "
                            >
